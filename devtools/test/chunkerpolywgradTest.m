...
wtsraw = wleg(:) * ( chnkr.h(:) ).'; wtsraw = wtsraw(:);
...
for i = 1:nt
    ...
    chnkr2 = chunkerpoly(verts2,cparams,p);
    chnkr2=refine(chnkr2,refopts);
    wtsraw2 = wleg(:) * ( chnkr2.h(:) ).'; wtsraw2 =wtsraw2(:);
    ...
    grad2 = vertgrad(chnkr2);
    g2 = grad2*pert(:);
    grads2 = vertdsdtgrad(chnkr2);
    gs2 = grads2*pert(:);
